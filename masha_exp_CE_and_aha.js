...
function scale_aha_trainRoutineBegin(snapshot) {
  return async function () {
    ...
    // update component parameters for each repeat
    text_aha_train.setText('Оцените его интенсивность от 1 до 7, кликнув мышкой: где 1 – «ощущение было слабо выраженным», 7 – «ощущение было ярко выраженным». Если ага-переживания не было нажмите любую цирфу');
